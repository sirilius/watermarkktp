...
***************************************************************************** */
  ...
  (function (TokenType) {
    ...
    TokenType[(TokenType["PREFIX_MATCH_TOKEN"] = 8)] =
      "PREFIX_MATCH_TOKEN";
    ...
    TokenType[(TokenType["SUFFIX_MATCH_TOKEN"] = 13)] =
      "SUFFIX_MATCH_TOKEN";
  ...
  (function (CSSImageType) {
    ...
    CSSImageType[(CSSImageType["LINEAR_GRADIENT"] = 1)] =
      "LINEAR_GRADIENT";
    CSSImageType[(CSSImageType["RADIAL_GRADIENT"] = 2)] =
      "RADIAL_GRADIENT";
  ...
  (function (CSSRadialExtent) {
    CSSRadialExtent[(CSSRadialExtent["CLOSEST_SIDE"] = 0)] =
      "CLOSEST_SIDE";
  ...
  var backgroundImage = {
    ...
    parse: function (tokens) {
      ...
      var first = tokens[0];
      if (
        first.type === TokenType.IDENT_TOKEN &&
        first.value === "none"
      ) {
        return [];
      }
  ...
  (function (LIST_STYLE_TYPE) {
    ...
    LIST_STYLE_TYPE[(LIST_STYLE_TYPE["UPPER_ALPHA"] = 10)] =
      "UPPER_ALPHA";
    ...
    for (
      ...
      if (isTextNode(childNode) && childNode.data.trim().length > 0) {
        parent.textNodes.push(
          new TextContainer(childNode, parent.styles)
        );
        ...
        return __generator(this, function (_b) {
          switch (_b.label) {
            ...
            case 14:
              ...
              if (
                !contains(container.styles.display, 2048 /* LIST_ITEM */)
              )
                return [3 /*break*/, 20];
